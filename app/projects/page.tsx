...
const PROJECTS: ProjectEntry[] = [
  {
    ...
    images: [
      { src: '/images/projects/stm32-imu/3D_View.png', alt: '3D view of the STM32F4 + IMU board' },
      { src: '/images/projects/stm32-imu/Top_Layer.png', alt: 'PCB top layer' },
      { src: '/images/projects/stm32-imu/Bottom_Layer.png', alt: 'PCB bottom layer' },
      { src: '/images/projects/stm32-imu/STM32F4.png', alt: 'STM32F4 microcontroller schematic' },
      { src: '/images/projects/stm32-imu/IMU.png', alt: 'MPU-6050 IMU schematic' },
      { src: '/images/projects/stm32-imu/Footprint.png', alt: 'Component footprints' },
    ],
    icon: null,
  },
  {
